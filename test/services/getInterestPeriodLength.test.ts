...
describe('when the term length is 1 year', () => {
  ...
  describe("when frequency is monthly", () => {
    it("returns 1", () => {
      expect(
        getInterestPeriodLength(Frequency.Monthly, termLength)
  ...
  describe("when frequency is quarterly", () => {
    it("returns 3", () => {
      expect(
        getInterestPeriodLength(Frequency.Quarterly, termLength)
  ...
  describe("when frequency is annually", () => {
    it("returns 12", () => {
      expect(
        getInterestPeriodLength(Frequency.Annually, termLength)
  ...
  describe('when frequency is at maturity', () => {
    it('returns 12', () => {
      expect(
        getInterestPeriodLength(Frequency.AtMaturity, termLength)
      ).toEqual(new BigNumber(12))
    })
...
describe("when frequency is at maturity", () => {
  describe("when term length is 3 years", () => {
    ...
    it("returns 36", () => {
      expect(
        getInterestPeriodLength(Frequency.AtMaturity, termLength)
      ).toEqual(termLength.multipliedBy(new BigNumber(12)))
    })
  })
})
